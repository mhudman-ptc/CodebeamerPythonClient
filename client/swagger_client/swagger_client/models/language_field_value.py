...
class LanguageFieldValue(AbstractFieldValue):
    ...
    def __init__(self, values=None, *args, **kwargs):  # noqa: E501
        """LanguageFieldValue - a model defined in Swagger"""  # noqa: E501
        self._values = None
    ...
    @property
    def values(self):
        """Gets the values of this LanguageFieldValue.  # noqa: E501

        Language codes  # noqa: E501

        :return: The values of this LanguageFieldValue.  # noqa: E501
        :rtype: list[str]
        """
        return self._values
    ...
    def values(self, values):
        """Sets the values of this LanguageFieldValue.

        Language codes  # noqa: E501

        :param values: The values of this LanguageFieldValue.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LanguageFieldValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LanguageFieldValue):
            return False
