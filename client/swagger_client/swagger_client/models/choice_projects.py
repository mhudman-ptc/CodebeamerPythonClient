...
class ChoiceProjects(BaseTrackerFieldChoiceOption):
    ...
    def __init__(self, reference_filters=None, *args, **kwargs):  # noqa: E501
        """ChoiceProjects - a model defined in Swagger"""  # noqa: E501
    ...
    def reference_filters(self):
        """Gets the reference_filters of this ChoiceProjects.  # noqa: E501


        :return: The reference_filters of this ChoiceProjects.  # noqa: E501
    ...
    def reference_filters(self, reference_filters):
        """Sets the reference_filters of this ChoiceProjects.


        :param reference_filters: The reference_filters of this ChoiceProjects.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChoiceProjects, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChoiceProjects):
            return False
