...
class TrackerFieldsStatusPermissions(BaseModel):
    """
    All field permissions by role for specific status
    """ # noqa: E501
    permissions: Optional[List[TrackerFieldPermissions]] = Field(default=None, description="Permissions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [TrackerFieldPermissions.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
        return _obj
