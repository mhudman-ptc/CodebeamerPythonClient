...
class Comment(BaseModel):
    ...
    """ # noqa: E501
    attachments: Optional[List[Attachment]] = Field(default=None, description="Attachments of a comment")
    comment: Optional[StrictStr] = Field(default=None, description="Text of a comment")
    comment_format: Optional[StrictStr] = Field(default=None, description="Format of a comment", alias="commentFormat")
    ...
    parent: Optional[CommentReference] = None
    version: Optional[StrictInt] = Field(default=None, description="Version of a comment")
    __properties: ClassVar[List[str]] = ["attachments", "comment", "commentFormat", "createdAt", "createdBy", "id", "modifiedAt", "modifiedBy", "name", "parent", "version"]

    @field_validator('comment_format')
    def comment_format_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "commentFormat": obj.get("commentFormat"),
            ...
            "name": obj.get("name"),
            "parent": CommentReference.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
