...
class TrackerPermission(BaseModel):
    """
    TrackerPermission
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the permission")
    id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Id of the entity")
    label: Optional[StrictStr] = Field(default=None, description="Variable name of the permission")
    name: Optional[StrictStr] = Field(default=None, description="Name of the entity")
    __properties: ClassVar[List[str]] = ["description", "id", "label", "name"]
