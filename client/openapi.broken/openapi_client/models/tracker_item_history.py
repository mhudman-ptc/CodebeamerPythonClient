...
class TrackerItemHistory(BaseModel):
    """
    Tracker item history containing all versions of an item.
    """ # noqa: E501
    versions: Optional[List[TrackerItemHistoryRevision]] = Field(default=None, description="List of version changes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [TrackerItemHistoryRevision.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
