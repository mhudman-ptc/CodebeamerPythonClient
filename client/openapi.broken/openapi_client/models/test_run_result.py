...
class TestRunResult(BaseModel):
    ...
    Multiple Test Runs
    """ # noqa: E501
    test_runs: Optional[List[TrackerItem]] = Field(default=None, alias="testRuns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testRuns": [TrackerItem.from_dict(_item) for _item in obj["testRuns"]] if obj.get("testRuns") is not None else None
        })
        return _obj
