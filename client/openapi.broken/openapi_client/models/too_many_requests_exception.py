...
class TooManyRequestsException(BaseModel):
    ...
    retry_after_second: Optional[StrictInt] = Field(default=None, alias="retryAfterSecond")
    __properties: ClassVar[List[str]] = ["message", "resourceUri", "retryAfterSecond"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "retryAfterSecond": obj.get("retryAfterSecond")
        })
        return _obj
