...
class DecimalField(AbstractField):
    ...
    Decimal field
    """ # noqa: E501
    max: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Maximum value of a field")
    min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Minimum value of a field")
