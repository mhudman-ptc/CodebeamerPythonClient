...
class ArtifactRevisionSearchResult(BaseModel):
    """
    ...
    revisions: Optional[List[ArtifactRevision]] = Field(default=None, description="Found artifact revision")
    total: Optional[StrictInt] = Field(default=None, description="Number of matched tracker items by the search criteria")
    __properties: ClassVar[List[str]] = ["page", "pageSize", "revisions", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "revisions": [ArtifactRevision.from_dict(_item) for _item in obj["revisions"]] if obj.get("revisions") is not None else None,
            "total": obj.get("total")
        })
        return _obj
