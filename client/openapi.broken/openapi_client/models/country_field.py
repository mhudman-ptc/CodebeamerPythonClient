...
class CountryField(AbstractField):
    ...
    Country field
    """ # noqa: E501
    available_options: Optional[List[StrictStr]] = Field(default=None, alias="availableOptions")
    multiple_values: Optional[StrictBool] = Field(default=None, description="Multiple values state of a field", alias="multipleValues")
    __properties: ClassVar[List[str]] = ["description", "formula", "hidden", "hideIfDependencyFormula", "id", "legacyRestName", "mandatoryIfDependencyFormula", "mandatoryInStatuses", "name", "sharedFields", "title", "trackerItemField", "type", "valueModel", "availableOptions", "multipleValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availableOptions": obj.get("availableOptions"),
