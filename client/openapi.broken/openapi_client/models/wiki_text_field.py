...
class WikiTextField(AbstractField):
    ...
    Wiki text field
    """ # noqa: E501
    max: Optional[StrictInt] = Field(default=None, description="Max length of value of a field")
    min: Optional[StrictInt] = Field(default=None, description="Minimum length of value of a field")
    __properties: ClassVar[List[str]] = ["description", "formula", "hidden", "hideIfDependencyFormula", "id", "legacyRestName", "mandatoryIfDependencyFormula", "mandatoryInStatuses", "name", "sharedFields", "title", "trackerItemField", "type", "valueModel", "max", "min"]
