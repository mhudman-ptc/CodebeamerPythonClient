...
class TrackerItemFieldAccessibility(BaseModel):
    """
    Accessibilities of fields
    """ # noqa: E501
    editable: Optional[StrictBool] = Field(default=None, description="Field is editable")
    field: Optional[FieldReference] = None
    mandatory: Optional[StrictBool] = Field(default=None, description="Field is mandatory")
    visible: Optional[StrictBool] = Field(default=None, description="Field is visible")
    __properties: ClassVar[List[str]] = ["editable", "field", "mandatory", "visible"]
