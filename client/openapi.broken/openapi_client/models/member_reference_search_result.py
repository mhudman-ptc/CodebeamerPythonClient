...
class MemberReferenceSearchResult(BaseModel):
    """
    Paginated search result of members
    """ # noqa: E501
    members: Optional[List[AbstractReference]] = Field(default=None, description="Found members")
    ...
    __properties: ClassVar[List[str]] = ["members", "page", "pageSize", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [AbstractReference.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "page": obj.get("page"),
