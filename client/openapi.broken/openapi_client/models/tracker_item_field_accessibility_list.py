...
class TrackerItemFieldAccessibilityList(BaseModel):
    """
    TrackerItemFieldAccessibilityList
    """ # noqa: E501
    fields: Optional[List[TrackerItemFieldAccessibility]] = Field(default=None, description="Accessibilities of fields")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [TrackerItemFieldAccessibility.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
