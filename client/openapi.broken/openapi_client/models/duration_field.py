...
class DurationField(AbstractField):
    ...
    Duration field
    """ # noqa: E501
    max: Optional[StrictStr] = Field(default=None, description="Maximum value of a field")
    min: Optional[StrictStr] = Field(default=None, description="Minimum value of a field")
