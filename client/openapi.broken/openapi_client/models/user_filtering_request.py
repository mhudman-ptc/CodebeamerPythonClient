...
class UserFilteringRequest(BaseModel):
    """
    ...
    project_id: Optional[StrictInt] = Field(default=None, description="Id of the project where the user is a member", alias="projectId")
    user_status: Optional[StrictStr] = Field(default=None, description="Status of the user", alias="userStatus")
    __properties: ClassVar[List[str]] = ["email", "firstName", "lastName", "name", "projectId", "userStatus"]
