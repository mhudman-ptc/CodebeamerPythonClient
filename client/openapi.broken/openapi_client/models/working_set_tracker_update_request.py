...
class WorkingSetTrackerUpdateRequest(BaseModel):
    """
    WorkingSetTrackerUpdateRequest
    """ # noqa: E501
    baseline_id: Optional[StrictInt] = Field(default=None, alias="baselineId")
    cbql: Optional[StrictStr] = None
    tracker: TrackerReference
    __properties: ClassVar[List[str]] = ["baselineId", "cbql", "tracker"]
