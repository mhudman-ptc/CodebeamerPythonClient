...
class UserGroup(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description of a user group")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "createdBy", "description", "id", "modifiedAt", "modifiedBy", "name"]
