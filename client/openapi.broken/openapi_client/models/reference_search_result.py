...
class ReferenceSearchResult(BaseModel):
    ...
    references: Optional[List[AbstractReference]] = Field(default=None, description="Found references")
    total: Optional[StrictInt] = Field(default=None, description="Number of matched tracker items by the search criteria")
    __properties: ClassVar[List[str]] = ["page", "pageSize", "references", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "references": [AbstractReference.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None,
            "total": obj.get("total")
        })
        return _obj
