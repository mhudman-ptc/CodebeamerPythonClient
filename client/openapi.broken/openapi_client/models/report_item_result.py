...
class ReportItemResult(BaseModel):
    ...
    ReportItemResult
    """ # noqa: E501
    items: Optional[List[ReportItem]] = Field(default=None, description="Found tracker items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ReportItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "page": obj.get("page"),
