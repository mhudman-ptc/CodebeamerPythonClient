...
class TableFieldValue(AbstractFieldValue):
    ...
    """ # noqa: E501
    values: Optional[List[List[AbstractFieldValue]]] = Field(default=None, description="Table values")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "values": [
                    [AbstractFieldValue.from_dict(_inner_item) for _inner_item in _item]
