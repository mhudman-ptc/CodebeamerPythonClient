...
class Attachment(BaseModel):
    ...
    sha512: Optional[StrictStr] = Field(default=None, description="Hash of a attachment")
    size: Optional[StrictInt] = Field(default=None, description="Size of a attachment")
    version: Optional[StrictInt] = Field(default=None, description="Version of a attachment")
    __properties: ClassVar[List[str]] = ["createdAt", "createdBy", "description", "descriptionFormat", "id", "modifiedAt", "modifiedBy", "name", "sha512", "size", "version"]
