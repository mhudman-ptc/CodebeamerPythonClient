...
class TrackerItemRevision(BaseModel):
    """
    Tracker item revision identifier
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Tracker item id")
    version: Optional[StrictInt] = Field(default=None, description="Tracker item version")
