...
class IntegerField(AbstractField):
    ...
    Integer field
    """ # noqa: E501
    max: Optional[StrictInt] = Field(default=None, description="Maximum value of a field")
    min: Optional[StrictInt] = Field(default=None, description="Minimum value of a field")
