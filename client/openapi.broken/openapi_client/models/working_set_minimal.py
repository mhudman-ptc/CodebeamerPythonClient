...
class WorkingSetMinimal(BaseModel):
    """
    Minimal information of a Working-Set
    """ # noqa: E501
    created_at: Optional[datetime] = Field(default=None, description="The date when the Working-Set was created", alias="createdAt")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "deleted", "id", "name", "type"]
