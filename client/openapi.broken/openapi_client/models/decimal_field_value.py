...
class DecimalFieldValue(AbstractFieldValue):
    ...
    """ # noqa: E501
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Double value")
    __properties: ClassVar[List[str]] = ["fieldId", "name", "sharedFieldName", "sharedFieldNames", "type", "value"]
