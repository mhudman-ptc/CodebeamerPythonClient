...
class Label(BaseModel):
    ...
    hidden: Optional[StrictBool] = Field(default=None, description="Whether the label is hidden or not")
    ...
    private_label: Optional[StrictBool] = Field(default=None, description="Whether the label is private or not", alias="privateLabel")
    __properties: ClassVar[List[str]] = ["createdAt", "createdBy", "hidden", "id", "name", "privateLabel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "privateLabel": obj.get("privateLabel")
        })
        return _obj
