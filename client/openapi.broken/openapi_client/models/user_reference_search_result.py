...
class UserReferenceSearchResult(BaseModel):
    """
    ...
    users: Optional[List[UserReference]] = Field(default=None, description="Found users")
    __properties: ClassVar[List[str]] = ["page", "pageSize", "total", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "users": [UserReference.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
