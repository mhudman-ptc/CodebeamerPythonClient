...
class JobReference(BaseModel):
    ...
    """ # noqa: E501
    job_id: StrictInt = Field(description="Id of the job", alias="jobId")
    job_type: StrictStr = Field(description="Type of a background job", alias="jobType")
    __properties: ClassVar[List[str]] = ["jobId", "jobType"]
