...
class TrackerSearchResult(BaseModel):
    """
    ...
    trackers: Optional[List[Tracker]] = Field(default=None, description="Found tracker items")
    __properties: ClassVar[List[str]] = ["page", "pageSize", "total", "trackers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "trackers": [Tracker.from_dict(_item) for _item in obj["trackers"]] if obj.get("trackers") is not None else None
        })
        return _obj
