...
class TrackerItemReferenceSearchResult(BaseModel):
    """
    One page of tracker item references.
    """ # noqa: E501
    item_refs: Optional[List[TrackerItemReference]] = Field(default=None, description="Found tracker item references", alias="itemRefs")
    ...
    __properties: ClassVar[List[str]] = ["itemRefs", "page", "pageSize", "total"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in item_refs (list)
        _items = []
        if self.item_refs:
            for _item in self.item_refs:
                if _item:
                    _items.append(_item.to_dict())
            _dict['itemRefs'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "itemRefs": [TrackerItemReference.from_dict(_item) for _item in obj["itemRefs"]] if obj.get("itemRefs") is not None else None,
            "page": obj.get("page"),
