...
class TrackerItemRowChange(AbstractTrackerItemChange):
    ...
    """ # noqa: E501
    row_number: Optional[StrictInt] = Field(default=None, description="Index of the changed row", alias="rowNumber")
    __properties: ClassVar[List[str]] = ["field", "name", "newValue", "oldValue", "type", "rowNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "newValue": AbstractFieldValue.from_dict(obj["newValue"]) if obj.get("newValue") is not None else None,
            "oldValue": AbstractFieldValue.from_dict(obj["oldValue"]) if obj.get("oldValue") is not None else None,
            "type": obj.get("type"),
