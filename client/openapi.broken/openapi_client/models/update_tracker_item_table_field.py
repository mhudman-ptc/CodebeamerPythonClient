...
class UpdateTrackerItemTableField(BaseModel):
    """
    UpdateTrackerItemTableField
    """ # noqa: E501
    rows: Optional[List[List[AbstractFieldValue]]] = Field(default=None, description="Table rows of a tracker table item")
