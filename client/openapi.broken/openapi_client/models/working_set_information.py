...
class WorkingSetInformation(BaseModel):
    """
    Information of a Working-Set
    """ # noqa: E501
    children: Optional[List[WorkingSetReference]] = Field(default=None, description="The children of the given Working-Set")
    ...
    parent: Optional[WorkingSetReference] = None
    project: Optional[ProjectReference] = None
    root: Optional[WorkingSetReference] = None
    type: Optional[StrictStr] = Field(default=None, description="Type of a referenced object")
    __properties: ClassVar[List[str]] = ["children", "createdAt", "createdBy", "deleted", "id", "name", "parent", "project", "root", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": [WorkingSetReference.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None,
            "createdAt": obj.get("createdAt"),
            "createdBy": UserReference.from_dict(obj["createdBy"]) if obj.get("createdBy") is not None else None,
            "deleted": obj.get("deleted"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "parent": WorkingSetReference.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "project": ProjectReference.from_dict(obj["project"]) if obj.get("project") is not None else None,
            "root": WorkingSetReference.from_dict(obj["root"]) if obj.get("root") is not None else None,
            "type": obj.get("type")
        })
        return _obj
