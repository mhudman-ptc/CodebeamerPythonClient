...
class OutlineItemSearchResult(BaseModel):
    """
    Paginated search result of outline items
    """ # noqa: E501
    outline_items: Optional[List[OutlineItem]] = Field(default=None, description="Found outline items", alias="outlineItems")
    ...
    __properties: ClassVar[List[str]] = ["outlineItems", "page", "pageSize", "total"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in outline_items (list)
        _items = []
        if self.outline_items:
            for _item in self.outline_items:
                if _item:
                    _items.append(_item.to_dict())
            _dict['outlineItems'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outlineItems": [OutlineItem.from_dict(_item) for _item in obj["outlineItems"]] if obj.get("outlineItems") is not None else None,
            "page": obj.get("page"),
