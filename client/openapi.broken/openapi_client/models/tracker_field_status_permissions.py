...
class TrackerFieldStatusPermissions(BaseModel):
    """
    Field permissions by role for specific status
    """ # noqa: E501
    permissions: Optional[List[AccessPermission]] = Field(default=None, description="Access permissions by role")
    status: Optional[ChoiceOptionReference] = None
    __properties: ClassVar[List[str]] = ["permissions", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": ChoiceOptionReference.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
