...
class FailedOperation(BaseModel):
    ...
    """ # noqa: E501
    exception_message: Optional[StrictStr] = Field(default=None, description="Exception message", alias="exceptionMessage")
    id: Optional[StrictInt] = Field(default=None, description="Entity id")
    __properties: ClassVar[List[str]] = ["exceptionMessage", "id"]
