...
class MemberField(AbstractField):
    ...
    Member field
    """ # noqa: E501
    member_types: Optional[List[StrictStr]] = Field(default=None, description="Supported member type of a member field", alias="memberTypes")
    multiple_values: Optional[StrictBool] = Field(default=None, description="Multiple values state of a field", alias="multipleValues")
    __properties: ClassVar[List[str]] = ["description", "formula", "hidden", "hideIfDependencyFormula", "id", "legacyRestName", "mandatoryIfDependencyFormula", "mandatoryInStatuses", "name", "sharedFields", "title", "trackerItemField", "type", "valueModel", "memberTypes", "multipleValues"]

    @field_validator('member_types')
    def member_types_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['USER', 'ROLE', 'GROUP']):
                raise ValueError("each list item must be one of ('USER', 'ROLE', 'GROUP')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memberTypes": obj.get("memberTypes"),
