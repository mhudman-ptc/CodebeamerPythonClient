...
class TrackerItemSearchResult(BaseModel):
    """
    One page of tracker items.
    """ # noqa: E501
    items: Optional[List[TrackerItem]] = Field(default=None, description="Found tracker items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [TrackerItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "page": obj.get("page"),
