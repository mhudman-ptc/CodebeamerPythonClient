...
class Role(BaseModel):
    ...
    Role
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of a role")
    description_format: Optional[StrictStr] = Field(default=None, description="Format of a role's description", alias="descriptionFormat")
