...
class TrackerItemFieldMapping(BaseModel):
    """
    ...
    var_property: Optional[StrictStr] = Field(default=None, description="Tracker field property name", alias="property")
    type_name: Optional[StrictStr] = Field(default=None, description="Tracker field type", alias="typeName")
    __properties: ClassVar[List[str]] = ["id", "name", "property", "typeName"]
