...
class TestCreateTestRunFromTestSetsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateTestRunFromTestSetsRequest:
        """Test CreateTestRunFromTestSetsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTestRunFromTestSetsRequest`
        """
        model = CreateTestRunFromTestSetsRequest()
        if include_optional:
            return CreateTestRunFromTestSetsRequest(
