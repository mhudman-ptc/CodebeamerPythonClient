...
class TestTrackerItemSearchResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackerItemSearchResult:
        """Test TrackerItemSearchResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackerItemSearchResult`
        """
        model = TrackerItemSearchResult()
        if include_optional:
            return TrackerItemSearchResult(
                items = [
                    openapi_client.models.tracker_item.TrackerItem(
                        accrued_millis = 56, 
                        areas = [
