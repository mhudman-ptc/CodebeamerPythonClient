...
class TestTrackerItemWithTrackerItemReviewsExport(unittest.TestCase):
    """TrackerItemWithTrackerItemReviewsExport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackerItemWithTrackerItemReviewsExport:
        """Test TrackerItemWithTrackerItemReviewsExport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackerItemWithTrackerItemReviewsExport`
        """
        model = TrackerItemWithTrackerItemReviewsExport()
        if include_optional:
            return TrackerItemWithTrackerItemReviewsExport(
                tracker_item = openapi_client.models.tracker_item.TrackerItem(
                    accrued_millis = 56, 
                    areas = [
                ...
                tracker_item_reviews = [
                    openapi_client.models.tracker_item_review_export.TrackerItemReviewExport(
                        reviewers = [
    ...
    def testTrackerItemWithTrackerItemReviewsExport(self):
        """Test TrackerItemWithTrackerItemReviewsExport"""
