...
class UserGroupReference(AbstractReference):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """UserGroupReference - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserGroupReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserGroupReference):
            return False
