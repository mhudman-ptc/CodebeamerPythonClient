...
class BranchReference(AbstractReference):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """BranchReference - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BranchReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BranchReference):
            return False
