...
class ChoiceFieldValue(AbstractFieldValue):
    ...
    def __init__(self, values=None, *args, **kwargs):  # noqa: E501
        """ChoiceFieldValue - a model defined in Swagger"""  # noqa: E501
        self._values = None
    ...
    @property
    def values(self):
        """Gets the values of this ChoiceFieldValue.  # noqa: E501

        Values of the choice option field  # noqa: E501

        :return: The values of this ChoiceFieldValue.  # noqa: E501
    ...
    def values(self, values):
        """Sets the values of this ChoiceFieldValue.

        Values of the choice option field  # noqa: E501

        :param values: The values of this ChoiceFieldValue.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChoiceFieldValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChoiceFieldValue):
            return False
