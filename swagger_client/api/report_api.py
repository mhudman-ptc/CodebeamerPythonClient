...
class ReportApi(object):
    ...
    def create_report(self, body, **kwargs):  # noqa: E501
        ...
        :param SimpleReportSettings body: (required)
    ...
    def create_report_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SimpleReportSettings',  # noqa: E501
    ...
    def get_report_by_id(self, report_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int report_id: Id of a report (required)
    ...
    def get_report_by_id_with_http_info(self, report_id, **kwargs):  # noqa: E501
        ...
        all_params = ['report_id', 'page', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_report_items_by_id(self, report_id, **kwargs):  # noqa: E501
        """Get a report items by id of the report  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_report_items_by_id(report_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_report_items_by_id_with_http_info(report_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_report_items_by_id_with_http_info(report_id, **kwargs)  # noqa: E501
            return data

    def get_report_items_by_id_with_http_info(self, report_id, **kwargs):  # noqa: E501
        """Get a report items by id of the report  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_report_items_by_id_with_http_info(report_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_report_items_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'report_id' is set
        if ('report_id' not in params or
                params['report_id'] is None):
            raise ValueError("Missing the required parameter `report_id` when calling `get_report_items_by_id`")  # noqa: E501
    ...
    def update_report(self, body, report_id, **kwargs):  # noqa: E501
        """Update report settings  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_report(body, report_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_report_with_http_info(body, report_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_report_with_http_info(body, report_id, **kwargs)  # noqa: E501
            return data

    def update_report_with_http_info(self, body, report_id, **kwargs):  # noqa: E501
        """Update report settings  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_report_with_http_info(body, report_id, async_req=True)
        >>> result = thread.get()
